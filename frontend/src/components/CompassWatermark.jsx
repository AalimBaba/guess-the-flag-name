...
export default function CompassWatermark() {
  return (
    <svg
      ...
      aria-hidden="true"
    >
      <g transform="translate(650 150)" stroke="currentColor" fill="none" strokeWidth="1.5">
        <circle r="120" />
        <circle r="90" />
        <circle r="4" fill="currentColor" stroke="none" />
        <path d="M0,-120 L10,-20 L0,0 L-10,-20 Z" fill="currentColor" stroke="none" />
        <path d="M0,120 L10,20 L0,0 L-10,20 Z" fill="currentColor" fillOpacity="0.5" stroke="none" />
        <path d="M-120,0 L-20,-10 L0,0 L-20,10 Z" fill="currentColor" fillOpacity="0.5" stroke="none" />
        <path d="M120,0 L20,-10 L0,0 L20,10 Z" fill="currentColor" fillOpacity="0.5" stroke="none" />
